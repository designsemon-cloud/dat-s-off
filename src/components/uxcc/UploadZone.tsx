  ...
  if (preview) {
    return (
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl border border-border-strong bg-bg-tertiary p-3"
      >
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
        style={{ background: "var(--gradient-primary)", maskImage: "linear-gradient(black,black)", filter: "blur(20px)", opacity: 0.15 }}
      />
